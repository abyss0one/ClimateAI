...
const AdviceNTips = () => {
  ...
  return (
    <div id="learn">
      <div className="carousel relative bg-[url(https://file.rendit.io/n/YZwJKEcWyijHRrlYbAGM.png)] bg-cover bg-50%_50%  flex flex-col  md:h-[40vh] xs:h-100vh mb-10">
        ...
        <div className="text-Poppins leading-[22.7px] text-text_color_body">
          <Slider {...settings}>
            <div className="box rounded-lg md:h-[150px] h-[450px]  ">
